...
async function addCustomerReview(inv_id, account_id, review_text) {
    try {
        const sql =
            "INSERT INTO review (inv_id, account_id, review_text) VALUES ($1, $2, $3) RETURNING *";
...
/* ***************************
 *  Update reviews to the database
 * ************************** */
...
module.exports = { getReviewsById, addCustomerReview,  getReviewsByIdOnly,  getReviewsByReviewID, updateReviews, deleteReview };
